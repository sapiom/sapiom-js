...
The #1044 images use isolated browser fixtures at source 1b758499be576ab7e04d481ba1b4dc6e5a7b98d6. Before/after shows a retained Resume operation with stale workspace selection, then that same UUID/original-revision operation paused after explicit history refresh and re-selection. continue-conflict.png shows retained Retry Continue without a fresh-operation control. These screenshots prove UI action states, not native execution.
