...
const r=spawnSync(app,[path.resolve('scripts/release-diagnostics/managed.cjs'),path.dirname(app)],{env:{...process.env,ELECTRON_RUN_AS_NODE:'1'},encoding:'utf8',timeout:60000});
