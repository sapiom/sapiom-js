 ...
 * double-quote anything with spaces or shell-special characters (escaping any
 * embedded `"`). Double quotes rather than backslash-escaping because they
 * read the same on POSIX and Windows, and the agent CLIs accept both forms.
 */
