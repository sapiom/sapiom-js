...
export interface HarnessSession {
   ...
   * For a trusted replacement, this instead names the exact prior
   * HarnessSession whose durable FIFO was handed off; its brief may come from
   * an older recorded ancestor in the same continuation chain.
