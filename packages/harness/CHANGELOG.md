...
- f3e9c20: Add the right pane's Secrets tab: the credentials one agent's runs receive, with add, replace, delete, and .env import, all write-only against Sapiom.
