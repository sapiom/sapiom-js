...
- Name: web/e2e/chat.spec.ts >> when Terminal tab is active, the chat panel is aria-hidden and the terminal panel is in the DOM
- Location: web/e2e/chat.spec.ts:469:1
