...
import {
  inferServiceFromModel,
  getModelName,
  inferServiceFromMCPUrl,
} from "./service-inference";
...
describe("inferServiceFromMCPUrl", () => {
  it("extracts hostname from URL", () => {
    const service = inferServiceFromMCPUrl(
  ...
  it("handles different URL schemes", () => {
    ...
    const service2 = inferServiceFromMCPUrl(
  ...
  it("handles URL with path", () => {
    const service = inferServiceFromMCPUrl(
      "https://api.example.com/v1/mcp/endpoint",
      "test",
    );
