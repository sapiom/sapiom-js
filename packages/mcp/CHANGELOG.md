...
- 03da8e2: Re-sync the offline `AUTHORING_INSTRUCTIONS` fallback with the primer the server
...
- 054f749: New tool `sapiom_dev_app_publish` — publishes the project's `sapiom.json`
