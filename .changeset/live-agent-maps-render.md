...
Planner onboarding now stays in the coding agent's hidden launch context instead of appearing as a synthetic user turn, and signed-out local planner sessions receive the same scoped Agent Map tools as authenticated sessions.
